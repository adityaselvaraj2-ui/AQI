...
export function PollutantCardStackSection({
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute top-4 left-1/2 -translate-x-1/2 w-[700px] h-[280px] rounded-full blur-[100px] opacity-15"
        style={{ background: "radial-gradient(ellipse at center, var(--live) 0%, transparent 70%)" }}
      />
        ...
        <div className="w-full max-w-6xl mx-auto flex justify-center py-4">
          <CardStack<PollutantCardItem>
            ...
            renderCard={(item, { active }) => (
              <div
                className={`cs-card pollutant-card card-${item.id} ${active ? "is-active" : ""} w-full h-full flex flex-col justify-between p-5 sm:p-6`}
                data-pollutant={item.id}
              >
                {/* Layer 1: Base Dark Metal Gradient + Dual Atmospheric Spotlights */}
                <div className="cs-card-art" />

                {/* Layer 2: Dual Atmospheric Flow Waves (SVG) */}
                <svg
                  className="cs-card-wave"
                  viewBox="0 0 500 310"
                ...
                >
                  <path
                    d="M -20 130 C 90 60, 190 200, 310 110 C 400 45, 470 165, 520 120"
                    stroke="var(--line)"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeOpacity="0.75"
                  ...
                  />
                  <path
                    d="M -20 195 C 100 260, 210 130, 330 225 C 410 285, 480 180, 520 215"
                    stroke="var(--line)"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeOpacity="0.45"
                ...
                {/* Layer 3: Bottom Shadow Vignette for Text Contrast */}
                <div className="cs-card-shade" />

                {/* Card Top: Formula Badge + Sub-Index Badge */}
                <div className="cs-card-top flex items-start justify-between gap-2">
                ...
                <div className="cs-card-body my-auto py-1">
                  <div className="flex items-baseline gap-2">
                    <span
                      className="text-3xl sm:text-4xl font-black font-mono tracking-tight"
                      style={{
                        color: "var(--line)",
                        textShadow: "0 0 22px var(--c1)",
                      }}
                    >
                ...
                <div
                  className="card-content pt-2 grid grid-cols-2 gap-2 text-[10.5px] font-sans"
                  style={{ borderTop: "1px solid rgba(255, 255, 255, 0.08)" }}
                >
                  <div>
                    <span
                      className="block font-mono text-[9px] uppercase font-semibold"
                      style={{ color: "var(--line)", opacity: 0.85 }}
                    >
